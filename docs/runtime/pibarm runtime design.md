...
| D5  | Child agents become host-side multiplexing; tmux remains one renderer used by the CLI surface                                                                                                                                      | Keeps CLI visibility terminal-independent while GUI surfaces render native agent panes                                                 | Remote-controlling tmux from GUI clients, dropping visible CLI agents                                       |
