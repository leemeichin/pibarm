...
export const FEATURES: Feature[] = [
  ...
  { icon: "layers", eyebrow: "Butty", title: "Visible parallel agents", body: "Spawn scout, planner and worker agents beside the parent Pi in WezTerm panes you can watch, capture, and join." },
...
export const COMMANDS: Command[] = [
  ...
  { name: "/butty", args: "<task>", desc: "Start a WezTerm Butty with scout and planner panes.", tag: "wezterm" },
  { name: "/butty-spawn", args: "<role> <task>", desc: "Spawn one Butty agent in a WezTerm pane.", tag: "wezterm" },
  { name: "/butty-join", args: "[role|all]", desc: "Wait for agents, capture logs, and clean up panes.", tag: "wezterm" },
