...
export const FEATURES: Feature[] = [
  ...
  { icon: "layers", eyebrow: "Agent panes", title: "Visible parallel agents", body: "Standard subagent and worktree tools stream into automatic tmux panes, with the same captured results and a headless fallback." },
...
export const COMMANDS: Command[] = [
  ...
  { name: "/agents", args: "[name]", desc: "List managed agents or capture one agent log.", tag: "tmux" },
  { name: "/agents-attach", args: "", desc: "Focus the managed tmux window or show its attach command.", tag: "tmux" },
  { name: "/agents-kill", args: "[name|all]", desc: "Stop managed panes without touching the parent session.", tag: "tmux" },
